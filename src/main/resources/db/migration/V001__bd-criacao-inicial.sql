...
create table forma_de_pagamento (forma_pagamento_id bigint not null auto_increment, descricao varchar(255), primary key (forma_pagamento_id)) engine=InnoDB;
create table grupo (id_grupo bigint not null auto_increment, nome varchar(255), primary key (id_grupo)) engine=InnoDB;
...
create table usuario (id_usuario bigint not null, data_cadastro datetime not null, email varchar(255) not null, nome varchar(255) not null, senha varchar(255) not null, primary key (id_usuario)) engine=InnoDB;
